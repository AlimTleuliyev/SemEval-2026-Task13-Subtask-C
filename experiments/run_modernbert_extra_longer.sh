...
python train.py \
    ...
    --output_dir ./models/modernbert_extra_longer_full \
    --logging_steps 20 \
    --eval_steps 200 \
    --save_strategy steps \
    --save_steps 200 \
    ...
    --do_eval \
    --do_predict \
    --submission_file ./predictions/modernbert_extra_longer_submission.csv

echo ""
echo "✅ ModernBERT-Base training complete!"
echo "Model saved to: ./models/modernbert_extra_longer_full/final"
echo "Submission saved to: ./predictions/modernbert_extra_longer_submission.csv"
echo ""